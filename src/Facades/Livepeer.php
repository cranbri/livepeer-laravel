 ...
 * @method static mixed listLivestreams(array<string, string> $filters = [])
 ...
 * @method static mixed queryRealtimeViewership(array<string, string> $filters = [])
 * @method static mixed queryViewershipMetrics(array<string, string> $filters = [])
 * @method static mixed queryUsageMetrics(array<string, string> $filters = [])
 * @method static mixed queryPublicTotalViewsMetrics(string $playbackId)
 * @method static mixed queryCreatorViewershipMetrics(array<string, string> $filters = [])
